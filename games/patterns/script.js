...
var NTI11858045 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI11858045 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI1872235, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI1872235, name: "Field1", sons: null}]};
NTI11858045.node = NNI11858045;
...
function getAudio_11857220(id_11857222) {
  var result_11857223 = null;

  BeforeRet: do {
    result_11857223 = getId_11857046(id_11857222);
    break BeforeRet;
  } while (false);

  return result_11857223;

}
function playSound_11858027(id_11858029) {
    getAudio_11857220(id_11858029).play();
...
function randomize_11786001() {
    var time_11786203 = ((epochTime_11785141() * 1.0000000000000000e+003) & 2147483647);
...
function HEX26_11865485(x_11865489, y_11865491) {
  var result_11865493 = [];
    ...
    result_11865493 = new Array(chckRange(addInt((x_11865489).length, (y_11865491).length), 0, 2147483647)); for (var i=0;i<chckRange(addInt((x_11865489).length, (y_11865491).length), 0, 2147483647);++i) {result_11865493[i]=[];}    L1: do {
      var i_11865524 = 0;
      var colontmp__11891063 = 0;
      colontmp__11891063 = subInt((x_11865489).length, 1);
      var res_11891064 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11891064 <= colontmp__11891063)) break L3;
            i_11865524 = res_11891064;
            ...
            res_11891064 = addInt(res_11891064, 1);
          }
      } while(false);
    } while(false);
    L4: do {
      var i_11865538 = 0;
      var colontmp__11891070 = 0;
      colontmp__11891070 = subInt((y_11865491).length, 1);
      var res_11891071 = 0;
      L5: do {
          L6: while (true) {
          if (!(res_11891071 <= colontmp__11891070)) break L6;
            i_11865538 = res_11891071;
            ...
            res_11891071 = addInt(res_11891071, 1);
          }
      } while(false);
    } while(false);
...
function repeat_11865449(x_11865452, n_11865453) {
  var result_11865455 = [];
    ...
    L1: do {
      var i_11865469 = 0;
      var colontmp__11891077 = 0;
      colontmp__11891077 = n_11865453;
      var i_11891078 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11891078 < colontmp__11891077)) break L3;
            i_11865469 = i_11891078;
            result_11865455[chckIndx(i_11865469, 0, (result_11865455).length-1)] = nimCopy(null, x_11865452, NTI1208013);
            i_11891078 = addInt(i_11891078, 1);
          }
      } while(false);
    } while(false);
...
function shuffle_11865565(r_11865568, x_11865571) {
    L1: do {
      var i_11865583 = 0;
      var colontmp__11891081 = 0;
      colontmp__11891081 = ((x_11865571).length-1);
      var res_11891086 = colontmp__11891081;
      L2: do {
          L3: while (true) {
          if (!(1 <= res_11891086)) break L3;
            i_11865583 = res_11891086;
            var j_11865584 = rand_10565049(r_11865568, chckRange(i_11865583, 0, 2147483647));
            var Tmp4 = x_11865571[chckIndx(i_11865583, 0, (x_11865571).length-1)]; x_11865571[chckIndx(i_11865583, 0, (x_11865571).length-1)] = x_11865571[chckIndx(j_11865584, 0, (x_11865571).length-1)]; x_11865571[chckIndx(j_11865584, 0, (x_11865571).length-1)] = Tmp4;            res_11891086 = subInt(res_11891086, 1);
          }
      } while(false);
    } while(false);
...
function sampleTiles_11865136(tilenum_11865138, colornum_11865139, colors_11865140) {
  var result_11865142 = [];
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(res_11891033 <= tilenum_11865138)) break L3;
            n_11865199 = res_11891033;
            tiles_11865146.push(sample_11865202(colorPick_11865144));;
            res_11891033 = addInt(res_11891033, 1);
          }
      } while(false);
    } while(false);
...
function getBoxDivs_11858043() {
  var result_11858046 = {Field0: null, Field1: null};

  BeforeRet: do {
    var colontmp__11891098 = getId_11857046(makeNimstrLit("leftBox"));
    var colontmp__11891099 = getId_11857046(makeNimstrLit("rightBox"));
    nimCopy(result_11858046, {Field0: colontmp__11891098, Field1: colontmp__11891099}, NTI11858045);
    break BeforeRet;
  } while (false);

  return result_11858046;

}
function clearBoxDivs_11858076(leftBox_11858078, rightBox_11858079) {
    leftBox_11858078.innerHTML = "";
    rightBox_11858079.innerHTML = "";
...
function substr_1591022(s_1591024, first_1591025, last_1591026) {
  var result_1591027 = [];
    ...
    L1: do {
      var i_1591039 = 0;
      var colontmp__11891113 = 0;
      colontmp__11891113 = subInt(L_1591030, 1);
      var res_11891114 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11891114 <= colontmp__11891113)) break L3;
            i_1591039 = res_11891114;
            ...
            res_11891114 = addInt(res_11891114, 1);
          }
      } while(false);
    } while(false);
...
function nsuSplitChar(s_9695034, sep_9695035, maxsplit_9695036) {
  var result_9695038 = [];
    ...
    L1: do {
      ...
      var lastHEX60gensym26_11891107 = 0;
      var splitsHEX60gensym26_11891108 = maxsplit_9695036;
      L2: do {
          L3: while (true) {
          if (!(lastHEX60gensym26_11891107 <= (s_9695034).length)) break L3;
            var firstHEX60gensym26_11891110 = lastHEX60gensym26_11891107;
            L4: do {
                L5: while (true) {
                if (!((lastHEX60gensym26_11891107 < (s_9695034).length) && !((s_9695034[chckIndx(lastHEX60gensym26_11891107, 0, (s_9695034).length-1)] == sep_9695035)))) break L5;
                  lastHEX60gensym26_11891107 = addInt(lastHEX60gensym26_11891107, 1);
                }
            } while(false);
            if ((splitsHEX60gensym26_11891108 == 0)) {
            lastHEX60gensym26_11891107 = (s_9695034).length;
            }
            
            xHEX60gensym59_9700016 = substr_1591022(s_9695034, firstHEX60gensym26_11891110, subInt(lastHEX60gensym26_11891107, 1));
            ...
            splitsHEX60gensym26_11891108 = subInt(splitsHEX60gensym26_11891108, 1);
            lastHEX60gensym26_11891107 = addInt(lastHEX60gensym26_11891107, 1);
          }
      } while(false);
    } while(false);
...
function make_11857192(kind_11857194, properties_11857196) {
  var result_11857197 = null;
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11891102 < (properties_11857196).length)) break L3;
            property_11857205 = properties_11857196; property_11857205_Idx = chckIndx(i_11891102, 0, (properties_11857196).length-1);
            ...
            i_11891102 = addInt(i_11891102, 1);
          }
      } while(false);
    } while(false);
...
function HEX5BHEX5D_5675068(s_5675072, x_5675074) {
  var result_5675075 = [];
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11891133 < L_5675401)) break L3;
            i_5675409 = i_11891133;
            ...
            i_11891133 = addInt(i_11891133, 1);
          }
      } while(false);
    } while(false);
...
function nsuRepeatChar(c_9960124, count_9960125) {
  var result_9960126 = [];
    ...
    L1: do {
      var i_9960135 = 0;
      var colontmp__11891164 = 0;
      colontmp__11891164 = subInt(count_9960125, 1);
      var res_11891165 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11891165 <= colontmp__11891164)) break L3;
            i_9960135 = res_11891165;
            result_9960126[chckIndx(i_9960135, 0, (result_9960126).length-1)] = c_9960124;
            res_11891165 = addInt(res_11891165, 1);
          }
      } while(false);
    } while(false);
...
function find_11865019(a_11865023, item_11865024) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11891172 < (a_11865023).length)) break L3;
            i_11865058 = a_11865023; i_11865058_Idx = chckIndx(i_11891172, 0, (a_11865023).length-1);
            if ((i_11865058[i_11865058_Idx] == item_11865024)) {
            break BeforeRet;
            }
            
            result_11865025 = addInt(result_11865025, 1);
            i_11891172 = addInt(i_11891172, 1);
          }
      } while(false);
    } while(false);
    result_11865025 = -1;
...
function allTilesEqual_11858093() {
  var result_11858095 = false;

  BeforeRet: do {
    var colontmp__11891186 = getBoxDivs_11858043();
    var leftBox_11858096 = colontmp__11891186["Field0"];
    var rightBox_11858097 = colontmp__11891186["Field1"];
    L1: do {
      var n_11858107 = 0;
      var res_11891181 = 0;
      L2: do {
          L3: while (true) {
          if (!(res_11891181 <= 15)) break L3;
            n_11858107 = res_11891181;
            if (!((leftBox_11858096.children[chckIndx(n_11858107, 0, (leftBox_11858096.children).length-1)].id == rightBox_11858097.children[chckIndx(n_11858107, 0, (rightBox_11858097.children).length-1)].id))) {
            result_11858095 = false;
            break BeforeRet;
            }
            
            res_11891181 = addInt(res_11891181, 1);
          }
      } while(false);
    } while(false);
    result_11858095 = true;
    break BeforeRet;
  } while (false);

  return result_11858095;

}
function action_11865744(tile_11865746, colornum_11865747, colors_11865748) {
            function HEX3Aanonymous_11875215(__11875217) {
              
            }

    playSound_11858027(makeNimstrLit("click"));
    ...
    if (allTilesEqual_11858093()) {
    playSound_11858027(makeNimstrLit("win"));
    L1: do {
      var child_11875214 = null;
      var child_11875214_Idx = 0;
      var colontmp__11891175 = [];
      colontmp__11891175 = getId_11857046(makeNimstrLit("leftBox")).children;
      var i_11891177 = 0;
      var L_11891178 = (colontmp__11891175).length;
      L2: do {
          L3: while (true) {
          if (!(i_11891177 < L_11891178)) break L3;
            child_11875214 = colontmp__11891175; child_11875214_Idx = chckIndx(i_11891177, 0, (colontmp__11891175).length-1);
            child_11875214[child_11875214_Idx].onclick = HEX3Aanonymous_11875215;
            i_11891177 = addInt(i_11891177, 1);
            if (!(((colontmp__11891175).length == L_11891178))) {
...
function insert_11857126(parent_11857128, elements_11857130) {
    L1: do {
      ...
      L2: do {
          L3: while (true) {
          if (!(i_11891189 < (elements_11857130).length)) break L3;
            element_11857163 = elements_11857130; element_11857163_Idx = chckIndx(i_11891189, 0, (elements_11857130).length-1);
            parent_11857128.appendChild(element_11857163[element_11857163_Idx]);
            i_11891189 = addInt(i_11891189, 1);
          }
      } while(false);
    } while(false);
...
function assembleTiles_11875274(tiles_11875277, tilenum_11875278, colornum_11875279, colors_11875280) {
            colors_11875280 = nimCopy(null, colors_11875280, NTI10561020);
            function HEX3Aanonymous_11880001() {
                function HEX3Aanonymous_11885003(__11885005) {
                    action_11865744(leftTile_11885002, colornum_11875279, colors_11875280);

                  
                }

                var fmtRes_11880008 = [mnewString(0)];
                fmtRes_11880008[0].push.apply(fmtRes_11880008[0], makeNimstrLit("id="));;
                formatValue_10490080(fmtRes_11880008, 0, colors_11875280.nocolor, []);
                var leftTile_11885002 = make_11857192(makeNimstrLit("div"), [makeNimstrLit("class=clickTile"), nimCopy(null, fmtRes_11880008[0], NTI1208013)]);
                leftTile_11885002.style.borderRadius = toJSStr(borderRadius_11860014(n_11875292));
                leftTile_11885002.onclick = HEX3Aanonymous_11885003;
                insert_11857126(leftBox_11875281, [leftTile_11885002]);

              
            }

    var colontmp__11891097 = getBoxDivs_11858043();
    var leftBox_11875281 = colontmp__11891097["Field0"];
    var rightBox_11875282 = colontmp__11891097["Field1"];
    clearBoxDivs_11858076(leftBox_11875281, rightBox_11875282);
    L1: do {
      var n_11875292 = 0;
      var res_11891092 = 1;
      L2: do {
          L3: while (true) {
          if (!(res_11891092 <= 16)) break L3;
            n_11875292 = res_11891092;
            HEX3Aanonymous_11880001();
            var color_11885034 = nimCopy(null, tiles_11875277[chckIndx(subInt(n_11875292, 1), 0, (tiles_11875277).length-1)], NTI1208013);
            var fmtRes_11885037 = [mnewString(0)];
            fmtRes_11885037[0].push.apply(fmtRes_11885037[0], makeNimstrLit("id="));;
            formatValue_10490080(fmtRes_11885037, 0, color_11885034, []);
            var rightTile_11890002 = make_11857192(makeNimstrLit("div"), [makeNimstrLit("class=tile"), nimCopy(null, fmtRes_11885037[0], NTI1208013)]);
            rightTile_11890002.style.borderRadius = toJSStr(borderRadius_11860014(n_11875292));
            rightTile_11890002.style.backgroundColor = toJSStr(color_11885034);
            insert_11857126(rightBox_11875282, [rightTile_11890002]);
            res_11891092 = addInt(res_11891092, 1);
          }
      } while(false);
    } while(false);
...
function play() {
    playSound_11858027(makeNimstrLit("music"));
    var tiles_11891016 = sampleTiles_11865136(TILENUM_10561016[0], COLORNUM_10561018[0], COLORS_10561027);
    assembleTiles_11875274(tiles_11891016, TILENUM_10561016[0], COLORNUM_10561018[0], COLORS_10561027);
...
function formatInt_11900002(n_11900005, radix_11900006, spec_11900007) {
    var Tmp7;

  var result_11900008 = [];

    var v_11900201 = n_11900005;
    var negative_11900202 = (v_11900201 < 0);
    if (negative_11900202) {
    v_11900201 = mulInt(v_11900201, -1);
    }
    
    var xx_11900203 = [];
    if (spec_11900007.alternateForm) {
    switch (spec_11900007.typ) {
    case 88:
      xx_11900203 = nimCopy(null, makeNimstrLit("0x"), NTI1208013);
      break;
    case 120:
      xx_11900203 = nimCopy(null, makeNimstrLit("0x"), NTI1208013);
      break;
    case 98:
      xx_11900203 = nimCopy(null, makeNimstrLit("0b"), NTI1208013);
      break;
    case 111:
      xx_11900203 = nimCopy(null, makeNimstrLit("0o"), NTI1208013);
      break;
    default: 
      break;
    }
    ...
    if ((v_11900201 == 0)) {
    result_11900008 = nimCopy(null, makeNimstrLit("0"), NTI1208013);
    }
    else {
      result_11900008 = nimCopy(null, [], NTI1208013);
      L1: do {
          L2: while (true) {
          if (!(0 < v_11900201)) break L2;
            var d_11900206 = modInt(v_11900201, radix_11900006);
            v_11900201 = divInt(v_11900201, radix_11900006);
            result_11900008.push.apply(result_11900008, mkDigit_10436014(chckRange(d_11900206, -2147483648, 2147483647), spec_11900007.typ));;
          }
      } while(false);
      L3: do {
        var idx_11900215 = 0;
        var colontmp__11910067 = 0;
        colontmp__11910067 = divInt((result_11900008).length, 2);
        var i_11910068 = 0;
        L4: do {
            L5: while (true) {
            if (!(i_11910068 < colontmp__11910067)) break L5;
              idx_11900215 = i_11910068;
              var Tmp6 = result_11900008[chckIndx(idx_11900215, 0, (result_11900008).length-1)]; result_11900008[chckIndx(idx_11900215, 0, (result_11900008).length-1)] = result_11900008[chckIndx(subInt(subInt((result_11900008).length, idx_11900215), 1), 0, (result_11900008).length-1)]; result_11900008[chckIndx(subInt(subInt((result_11900008).length, idx_11900215), 1), 0, (result_11900008).length-1)] = Tmp6;              i_11910068 = addInt(i_11910068, 1);
            }
        } while(false);
      } while(false);
    }
    
    if (spec_11900007.padWithZero) {
    if (negative_11900202) Tmp7 = true; else {      Tmp7 = !((spec_11900007.sign == 45));    }    var sign_11910008 = Tmp7;
    var toFill_11910013 = subInt(subInt(subInt(spec_11900007.minimumWidth, (result_11900008).length), (xx_11900203).length), (sign_11910008 ? 1:0));
    if ((0 < toFill_11910013)) {
    result_11900008 = nimCopy(null, (nsuRepeatChar(48, chckRange(toFill_11910013, 0, 2147483647)) || []).concat(result_11900008 || []), NTI1208013);
    }
    
    }
    
    if (negative_11900202) {
    result_11900008 = nimCopy(null, (makeNimstrLit("-") || []).concat(xx_11900203 || [],result_11900008 || []), NTI1208013);
    }
    else {
    if (!((spec_11900007.sign == 45))) {
    result_11900008 = nimCopy(null, [spec_11900007.sign].concat(xx_11900203 || [],result_11900008 || []), NTI1208013);
    }
    else {
      result_11900008 = nimCopy(null, (xx_11900203 || []).concat(result_11900008 || []), NTI1208013);
    }
    }
    if ((spec_11900007.align == 60)) {
    L8: do {
      var i_11910019 = 0;
      var colontmp__11910071 = 0;
      colontmp__11910071 = (result_11900008).length;
      var i_11910072 = colontmp__11910071;
      L9: do {
          L10: while (true) {
          if (!(i_11910072 < spec_11900007.minimumWidth)) break L10;
            i_11910019 = i_11910072;
            addChar(result_11900008, spec_11900007.fill);;
            i_11910072 = addInt(i_11910072, 1);
          }
      } while(false);
    } while(false);
    }
    else {
      var toFill_11910020 = subInt(spec_11900007.minimumWidth, (result_11900008).length);
      if ((spec_11900007.align == 94)) {
      var half_11910021 = divInt(toFill_11910020, 2);
      result_11900008 = nimCopy(null, (nsuRepeatChar(spec_11900007.fill, chckRange(half_11910021, 0, 2147483647)) || []).concat(result_11900008 || [],nsuRepeatChar(spec_11900007.fill, chckRange(subInt(toFill_11910020, half_11910021), 0, 2147483647)) || []), NTI1208013);
      }
      else {
        if ((0 < toFill_11910020)) {
        result_11900008 = nimCopy(null, (nsuRepeatChar(spec_11900007.fill, chckRange(toFill_11910020, 0, 2147483647)) || []).concat(result_11900008 || []), NTI1208013);
        }
  ...
  return result_11900008;

}
function formatValue_11895001(result_11895004, result_11895004_Idx, value_11895005, specifier_11895006) {
  BeforeRet: do {
    if (((specifier_11895006).length == 0)) {
    result_11895004[result_11895004_Idx].push.apply(result_11895004[result_11895004_Idx], cstrToNimstr((value_11895005)+""));;
    break BeforeRet;
    }
    
    var spec_11895007 = parseStandardFormatSpecifier_10445322(specifier_11895006, 0, false);
    var radix_11895009 = 10;
    switch (spec_11895007.typ) {
    case 120:
    case 88:
      radix_11895009 = 16;
      break;
    ...
    case 111:
      ...
      break;
    default: 
      raiseException({message: (makeNimstrLit("invalid type in format string for number, expected one  of \'x\', \'X\', \'b\', \'d\', \'o\' but got: ") || []).concat([spec_11895007.typ]), parent: null, m_type: NTI1214643, name: null, trace: [], up: null}, "ValueError");
      break;
    }
    result_11895004[result_11895004_Idx].push.apply(result_11895004[result_11895004_Idx], formatInt_11900002(value_11895005, radix_11895009, spec_11895007));;
  } while (false);

  
}
function changeTiles(tile_11891193) {
    switch (toJSStr(cstrToNimstr(tile_11891193.innerHTML))) {
    case "3t":
    ...
    var fmtRes_11891194 = [mnewString(0)];
    formatValue_11895001(fmtRes_11891194, 0, TILENUM_10561016[0], []);
    fmtRes_11891194[0].push.apply(fmtRes_11891194[0], makeNimstrLit("t"));;
    tile_11891193.innerHTML = toJSStr(fmtRes_11891194[0]);

  
}
function changeColors(tile_11910076) {
    switch (toJSStr(cstrToNimstr(tile_11910076.innerHTML))) {
    case "1c":
    ...
    var fmtRes_11910077 = [mnewString(0)];
    formatValue_11895001(fmtRes_11910077, 0, COLORNUM_10561018[0], []);
    fmtRes_11910077[0].push.apply(fmtRes_11910077[0], makeNimstrLit("c"));;
    tile_11910076.innerHTML = toJSStr(fmtRes_11910077[0]);
...
function loadEmptyBoxes_11865677() {
    var colontmp__11915070 = getBoxDivs_11858043();
    var leftBox_11865679 = colontmp__11915070["Field0"];
    var rightBox_11865680 = colontmp__11915070["Field1"];
    clearBoxDivs_11858076(leftBox_11865679, rightBox_11865680);
    L1: do {
      var n_11865690 = 0;
      var res_11915065 = 1;
      L2: do {
          L3: while (true) {
          if (!(res_11915065 <= 16)) break L3;
            n_11865690 = res_11915065;
            var leftTile_11865693 = make_11857192(makeNimstrLit("div"), [makeNimstrLit("class=tile")]);
            var rightTile_11865696 = make_11857192(makeNimstrLit("div"), [makeNimstrLit("class=tile")]);
            leftTile_11865693.style.borderRadius = toJSStr(borderRadius_11860014(n_11865690));
            rightTile_11865696.style.borderRadius = toJSStr(borderRadius_11860014(n_11865690));
            insert_11857126(leftBox_11865679, [leftTile_11865693]);
            insert_11857126(rightBox_11865680, [rightTile_11865696]);
            res_11915065 = addInt(res_11915065, 1);
          }
      } while(false);
    } while(false);
